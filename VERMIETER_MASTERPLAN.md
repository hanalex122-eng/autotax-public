...
| 9 | **Mietvertrag Generator** | Şablon · PDF · imzaya hazır | 🔴 zorunlu | 🟡 **TEKNİK TAMAM** (Sprint 9 a+b+c, push `ab559d7`, 2026-07-23): Akte-içi sihirbaz · auto-fill · registry-tabanlı parametrik kloz motoru · immutable snapshot + Revision · tek-yönlü write-back · Unicode (Türkçe) PDF. Suite 49/49 + yerel E2E yeşil. **PRODUCTION: Mietrecht metin onayı bekliyor** (H9) — deploy hukuki karar; tercihen feature flag / "Beta · Muster ohne Gewähr". Deferred: Index/befristet/Gewerbe/WG/dijital imza |
